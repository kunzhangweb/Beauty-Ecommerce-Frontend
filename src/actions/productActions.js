...
import {
  ...
  PRODUCT_GENERATION_FAIL,
  PRODUCT_GENERATION_REQUEST,
...
export const createProduct = () => async (dispatch, getState) => {
  dispatch({
    type: PRODUCT_GENERATION_REQUEST,
  });
  ...
  try {
    ...
    dispatch({ type: PRODUCT_GENERATION_SUCCESS, payload: data.product });
  } catch (error) {
    const message =
      error.response && error.response.data.message
        ? error.response.data.message
        : error.message;
    dispatch({ type: PRODUCT_GENERATION_FAIL, payload: message });
  }
};
